  ...
  return (
    ...
    <Modal visible={visible} onRequestClose={onRequestClose}>
      ...
      <View style={styles.updateinfo}>
        <View style={{flexDirection: 'row', justifyContent: 'space-between', width: '88%', marginBottom: 50}}>
            <Text style={{fontSize: 24, color: 'black'}}>Cập nhật thông tin </Text>
        ...
        <View style={{marginBottom: 10}}>
            ...
            <MyInput 
                ...
                value={ten}
                onChangeText={(text: React.SetStateAction<string>)=>setTen(text)}
            />
        </View>
        <View>
